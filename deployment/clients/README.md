...
Entrega nativa actual: Android/Google TV y Fire TV con Android/Fire OS, app `top.absor.absorflix.tv`, versión preliminar `1.0.0-preview.4`. Corrige el icono principal de aplicación que seguía cuadrado en preview.3, además del acceso de TV. Se verificaron ambos mediante PackageManager; el aspecto en Fire TV físico sigue pendiente. Conserva la intro fluida de preview.2. El instalador del NAS añade la página de descarga y el manifiesto a `/web/absorflix/tv/` del montaje persistente de Absorflix; no reinicia Jellyfin.
