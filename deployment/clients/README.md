...
Entrega nativa actual: Android/Google TV y Fire TV con Android/Fire OS, app `top.absor.absorflix.tv`, versión preliminar `1.0.0-preview.4`. El icono principal y el acceso entregan recursos 16:9, pero la foto del Fire TV confirma que su menú sigue comprimiendo el banner en un cuadrado con franjas grises. El problema visual continúa abierto; consulta el [diagnóstico de Fire TV](androidtv/fire-tv-launcher.md). Conserva la intro fluida de preview.2. El instalador del NAS añade la página de descarga y el manifiesto a `/web/absorflix/tv/` del montaje persistente de Absorflix; no reinicia Jellyfin.
